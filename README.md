...
[INDEX For linkedinFoundation learning](/linkedin_foundation/readme.md)
...
[INDEX For k8s](/k8s/readme.md)

---

## 🔁 CI/CD & Automation

[INDEX For cicd](/cicd/readme.md)
...
[Follow these steps to clone this repository locally using **Visual Studio Code**](https://github.com/SereneSyntax04/Devops-hub/blob/main/InstallationGuide/gitclone.md)
